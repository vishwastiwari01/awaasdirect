import { Search, Building2, MessageSquare, PartyPopper } from 'lucide-react';

export function HowItWorks() {
    const steps = [
        { num: '1', icon: <Search className="w-8 h-8 text-emerald" />, title: 'Search & Discover', desc: 'Browse RERA-verified listings by city, type, and budget with AI-powered natural language search.' },
        { num: '2', icon: <Building2 className="w-8 h-8 text-emerald" />, title: 'Explore in 3D', desc: 'Take AI-generated virtual tours from your phone — no site visit needed before shortlisting.' },
        { num: '3', icon: <MessageSquare className="w-8 h-8 text-emerald" />, title: 'Chat Directly', desc: 'Message Aadhaar-verified owners directly. No broker, no commissions, no middlemen.' },
        { num: '4', icon: <PartyPopper className="w-8 h-8 text-emerald" />, title: 'Move In!', desc: 'Agree terms, sign your agreement, and move in. That simple — always zero brokerage.' },
    ];
